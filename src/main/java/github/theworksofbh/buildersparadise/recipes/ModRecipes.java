...
public class ModRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<BaseFletchingRecipe>> BASE_FLETCHING_RECIPE_SERIALIZER = SERIALIZERS.register("base_fletching", () -> BaseFletchingRecipe.SERIALIZER);
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<TippedFletchingRecipe>> TIPPED_FLETCHING_RECIPE_SERIALIZER = SERIALIZERS.register("tipped_fletching", () -> TippedFletchingRecipe.SERIALIZER);
