...
public class ModFluidTypes {
    ...
    public static final DeferredHolder<FluidType, BaseFluidType> NUCLEAR_WASTE_TYPE = register("nuclear_waste_fluid", FluidType.Properties.create().viscosity(1000).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL_LAVA).sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY_LAVA).isWaterLike(false), ResourceLocation.fromNamespaceAndPath(BuildersParadise.MODID, "block/nuclear_waste_flow"), ResourceLocation.fromNamespaceAndPath(BuildersParadise.MODID, "block/nuclear_waste_still"), 1.0F, 0.0F, 1.0F, 0.0F);
