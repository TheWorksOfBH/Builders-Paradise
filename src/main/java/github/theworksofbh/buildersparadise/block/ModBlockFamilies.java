...
public class ModBlockFamilies {
    ...
    public static final BlockFamily COBBLESTONE = familyBuilder(Blocks.COBBLESTONE).fence(ModBlocks.COBBLESTONE_FENCE.get()).getFamily();
    ...
    public static final BlockFamily BRICKS = familyBuilder(Blocks.BRICKS).fence(ModBlocks.BRICK_FENCE.get()).getFamily();
    ...
    public static final BlockFamily PRISMARINE = familyBuilder(Blocks.PRISMARINE).fence(ModBlocks.PRISMARINE_FENCE.get()).getFamily();
    ...
    public static final BlockFamily PRISMARINE_BRICKS = familyBuilder(Blocks.PRISMARINE_BRICKS).wall(ModBlocks.PRISMARINE_BRICK_WALL.get()).fence(ModBlocks.PRISMARINE_BRICK_FENCE.get()).getFamily();
    ...
    public static final BlockFamily NETHERRACK = familyBuilder(Blocks.NETHERRACK).stairs(ModBlocks.NETHERRACK_STAIRS.get()).slab(ModBlocks.NETHERRACK_SLAB.get()).wall(ModBlocks.NETHERRACK_WALL.get()).fence(ModBlocks.NETHERRACK_FENCE.get()).getFamily();
    ...
    public static final BlockFamily ELDER_PRISMARINE = familyBuilder(ModBlocks.ELDER_PRISMARINE.get()).slab(ModBlocks.ELDER_PRISMARINE_SLAB.get()).stairs(ModBlocks.ELDER_PRISMARINE_STAIRS.get()).wall(ModBlocks.ELDER_PRISMARINE_WALL.get()).fence(ModBlocks.ELDER_PRISMARINE_FENCE.get()).getFamily();
    public static final BlockFamily ELDER_PRISMARINE_BRICKS = familyBuilder(ModBlocks.ELDER_PRISMARINE_BRICKS.get()).slab(ModBlocks.ELDER_PRISMARINE_BRICK_SLAB.get()).stairs(ModBlocks.ELDER_PRISMARINE_BRICK_STAIRS.get()).wall(ModBlocks.ELDER_PRISMARINE_BRICK_WALL.get()).fence(ModBlocks.ELDER_PRISMARINE_BRICK_FENCE.get()).getFamily();
    ...
    public static final BlockFamily LAPIS = familyBuilder(Blocks.LAPIS_BLOCK).stairs(ModBlocks.LAPIS_STAIRS.get()).slab(ModBlocks.LAPIS_SLAB.get()).wall(ModBlocks.LAPIS_WALL.get()).polished(ModBlocks.LAPIS_BRICKS.get()).fence(ModBlocks.LAPIS_FENCE.get()).getFamily();
    ...
    public static final BlockFamily TERRACOTTA = familyBuilder(Blocks.TERRACOTTA).stairs(ModBlocks.TERRACOTTA_STAIRS.get()).slab(ModBlocks.TERRACOTTA_SLAB.get()).wall(ModBlocks.TERRACOTTA_WALL.get()).fence(ModBlocks.TERRACOTTA_FENCE.get()).getFamily();
    ...
    public static final BlockFamily WHITE_TERRACOTTA = familyBuilder(Blocks.WHITE_TERRACOTTA).stairs(ModBlocks.WHITE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.WHITE_TERRACOTTA_SLAB.get()).wall(ModBlocks.WHITE_TERRACOTTA_WALL.get()).fence(ModBlocks.WHITE_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily ORANGE_TERRACOTTA = familyBuilder(Blocks.ORANGE_TERRACOTTA).stairs(ModBlocks.ORANGE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.ORANGE_TERRACOTTA_SLAB.get()).wall(ModBlocks.ORANGE_TERRACOTTA_WALL.get()).fence(ModBlocks.ORANGE_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily MAGENTA_TERRACOTTA = familyBuilder(Blocks.MAGENTA_TERRACOTTA).stairs(ModBlocks.MAGENTA_TERRACOTTA_STAIRS.get()).slab(ModBlocks.MAGENTA_TERRACOTTA_SLAB.get()).wall(ModBlocks.MAGENTA_TERRACOTTA_WALL.get()).fence(ModBlocks.MAGENTA_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily LIGHT_BLUE_TERRACOTTA = familyBuilder(Blocks.LIGHT_BLUE_TERRACOTTA).stairs(ModBlocks.LIGHT_BLUE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.LIGHT_BLUE_TERRACOTTA_SLAB.get()).wall(ModBlocks.LIGHT_BLUE_TERRACOTTA_WALL.get()).fence(ModBlocks.LIGHT_BLUE_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily YELLOW_TERRACOTTA = familyBuilder(Blocks.YELLOW_TERRACOTTA).stairs(ModBlocks.YELLOW_TERRACOTTA_STAIRS.get()).slab(ModBlocks.YELLOW_TERRACOTTA_SLAB.get()).wall(ModBlocks.YELLOW_TERRACOTTA_WALL.get()).fence(ModBlocks.YELLOW_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily LIME_TERRACOTTA = familyBuilder(Blocks.LIME_TERRACOTTA).stairs(ModBlocks.LIME_TERRACOTTA_STAIRS.get()).slab(ModBlocks.LIME_TERRACOTTA_SLAB.get()).wall(ModBlocks.LIME_TERRACOTTA_WALL.get()).fence(ModBlocks.LIME_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily PINK_TERRACOTTA = familyBuilder(Blocks.PINK_TERRACOTTA).stairs(ModBlocks.PINK_TERRACOTTA_STAIRS.get()).slab(ModBlocks.PINK_TERRACOTTA_SLAB.get()).wall(ModBlocks.PINK_TERRACOTTA_WALL.get()).fence(ModBlocks.PINK_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily GRAY_TERRACOTTA = familyBuilder(Blocks.GRAY_TERRACOTTA).stairs(ModBlocks.GRAY_TERRACOTTA_STAIRS.get()).slab(ModBlocks.GRAY_TERRACOTTA_SLAB.get()).wall(ModBlocks.GRAY_TERRACOTTA_WALL.get()).fence(ModBlocks.GRAY_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily LIGHT_GRAY_TERRACOTTA = familyBuilder(Blocks.LIGHT_GRAY_TERRACOTTA).stairs(ModBlocks.LIGHT_GRAY_TERRACOTTA_STAIRS.get()).slab(ModBlocks.LIGHT_GRAY_TERRACOTTA_SLAB.get()).wall(ModBlocks.LIGHT_GRAY_TERRACOTTA_WALL.get()).fence(ModBlocks.LIGHT_GRAY_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily CYAN_TERRACOTTA = familyBuilder(Blocks.CYAN_TERRACOTTA).stairs(ModBlocks.CYAN_TERRACOTTA_STAIRS.get()).slab(ModBlocks.CYAN_TERRACOTTA_SLAB.get()).wall(ModBlocks.CYAN_TERRACOTTA_WALL.get()).fence(ModBlocks.CYAN_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily PURPLE_TERRACOTTA = familyBuilder(Blocks.PURPLE_TERRACOTTA).stairs(ModBlocks.PURPLE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.PURPLE_TERRACOTTA_SLAB.get()).wall(ModBlocks.PURPLE_TERRACOTTA_WALL.get()).fence(ModBlocks.PURPLE_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily BLUE_TERRACOTTA = familyBuilder(Blocks.BLUE_TERRACOTTA).stairs(ModBlocks.BLUE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.BLUE_TERRACOTTA_SLAB.get()).wall(ModBlocks.BLUE_TERRACOTTA_WALL.get()).fence(ModBlocks.BLUE_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily BROWN_TERRACOTTA = familyBuilder(Blocks.BROWN_TERRACOTTA).stairs(ModBlocks.BROWN_TERRACOTTA_STAIRS.get()).slab(ModBlocks.BROWN_TERRACOTTA_SLAB.get()).wall(ModBlocks.BROWN_TERRACOTTA_WALL.get()).fence(ModBlocks.BROWN_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily GREEN_TERRACOTTA = familyBuilder(Blocks.GREEN_TERRACOTTA).stairs(ModBlocks.GREEN_TERRACOTTA_STAIRS.get()).slab(ModBlocks.GREEN_TERRACOTTA_SLAB.get()).wall(ModBlocks.GREEN_TERRACOTTA_WALL.get()).fence(ModBlocks.GREEN_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily RED_TERRACOTTA = familyBuilder(Blocks.RED_TERRACOTTA).stairs(ModBlocks.RED_TERRACOTTA_STAIRS.get()).slab(ModBlocks.RED_TERRACOTTA_SLAB.get()).wall(ModBlocks.RED_TERRACOTTA_WALL.get()).fence(ModBlocks.RED_TERRACOTTA_FENCE.get()).getFamily();
    public static final BlockFamily BLACK_TERRACOTTA = familyBuilder(Blocks.BLACK_TERRACOTTA).stairs(ModBlocks.BLACK_TERRACOTTA_STAIRS.get()).slab(ModBlocks.BLACK_TERRACOTTA_SLAB.get()).wall(ModBlocks.BLACK_TERRACOTTA_WALL.get()).fence(ModBlocks.BLACK_TERRACOTTA_FENCE.get()).getFamily();

    public static final BlockFamily WHITE_CONCRETE = familyBuilder(Blocks.WHITE_CONCRETE).stairs(ModBlocks.WHITE_CONCRETE_STAIRS.get()).slab(ModBlocks.WHITE_CONCRETE_SLAB.get()).wall(ModBlocks.WHITE_CONCRETE_WALL.get()).fence(ModBlocks.WHITE_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily ORANGE_CONCRETE = familyBuilder(Blocks.ORANGE_CONCRETE).stairs(ModBlocks.ORANGE_CONCRETE_STAIRS.get()).slab(ModBlocks.ORANGE_CONCRETE_SLAB.get()).wall(ModBlocks.ORANGE_CONCRETE_WALL.get()).fence(ModBlocks.ORANGE_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily MAGENTA_CONCRETE = familyBuilder(Blocks.MAGENTA_CONCRETE).stairs(ModBlocks.MAGENTA_CONCRETE_STAIRS.get()).slab(ModBlocks.MAGENTA_CONCRETE_SLAB.get()).wall(ModBlocks.MAGENTA_CONCRETE_WALL.get()).fence(ModBlocks.MAGENTA_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily LIGHT_BLUE_CONCRETE = familyBuilder(Blocks.LIGHT_BLUE_CONCRETE).stairs(ModBlocks.LIGHT_BLUE_CONCRETE_STAIRS.get()).slab(ModBlocks.LIGHT_BLUE_CONCRETE_SLAB.get()).wall(ModBlocks.LIGHT_BLUE_CONCRETE_WALL.get()).fence(ModBlocks.LIGHT_BLUE_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily YELLOW_CONCRETE = familyBuilder(Blocks.YELLOW_CONCRETE).stairs(ModBlocks.YELLOW_CONCRETE_STAIRS.get()).slab(ModBlocks.YELLOW_CONCRETE_SLAB.get()).wall(ModBlocks.YELLOW_CONCRETE_WALL.get()).fence(ModBlocks.YELLOW_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily LIME_CONCRETE = familyBuilder(Blocks.LIME_CONCRETE).stairs(ModBlocks.LIME_CONCRETE_STAIRS.get()).slab(ModBlocks.LIME_CONCRETE_SLAB.get()).wall(ModBlocks.LIME_CONCRETE_WALL.get()).fence(ModBlocks.LIME_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily PINK_CONCRETE = familyBuilder(Blocks.PINK_CONCRETE).stairs(ModBlocks.PINK_CONCRETE_STAIRS.get()).slab(ModBlocks.PINK_CONCRETE_SLAB.get()).wall(ModBlocks.PINK_CONCRETE_WALL.get()).fence(ModBlocks.PINK_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily GRAY_CONCRETE = familyBuilder(Blocks.GRAY_CONCRETE).stairs(ModBlocks.GRAY_CONCRETE_STAIRS.get()).slab(ModBlocks.GRAY_CONCRETE_SLAB.get()).wall(ModBlocks.GRAY_CONCRETE_WALL.get()).fence(ModBlocks.GRAY_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily LIGHT_GRAY_CONCRETE = familyBuilder(Blocks.LIGHT_GRAY_CONCRETE).stairs(ModBlocks.LIGHT_GRAY_CONCRETE_STAIRS.get()).slab(ModBlocks.LIGHT_GRAY_CONCRETE_SLAB.get()).wall(ModBlocks.LIGHT_GRAY_CONCRETE_WALL.get()).fence(ModBlocks.LIGHT_GRAY_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily CYAN_CONCRETE = familyBuilder(Blocks.CYAN_CONCRETE).stairs(ModBlocks.CYAN_CONCRETE_STAIRS.get()).slab(ModBlocks.CYAN_CONCRETE_SLAB.get()).wall(ModBlocks.CYAN_CONCRETE_WALL.get()).fence(ModBlocks.CYAN_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily PURPLE_CONCRETE = familyBuilder(Blocks.PURPLE_CONCRETE).stairs(ModBlocks.PURPLE_CONCRETE_STAIRS.get()).slab(ModBlocks.PURPLE_CONCRETE_SLAB.get()).wall(ModBlocks.PURPLE_CONCRETE_WALL.get()).fence(ModBlocks.PURPLE_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily BLUE_CONCRETE = familyBuilder(Blocks.BLUE_CONCRETE).stairs(ModBlocks.BLUE_CONCRETE_STAIRS.get()).slab(ModBlocks.BLUE_CONCRETE_SLAB.get()).wall(ModBlocks.BLUE_CONCRETE_WALL.get()).fence(ModBlocks.BLUE_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily BROWN_CONCRETE = familyBuilder(Blocks.BROWN_CONCRETE).stairs(ModBlocks.BROWN_CONCRETE_STAIRS.get()).slab(ModBlocks.BROWN_CONCRETE_SLAB.get()).wall(ModBlocks.BROWN_CONCRETE_WALL.get()).fence(ModBlocks.BROWN_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily GREEN_CONCRETE = familyBuilder(Blocks.GREEN_CONCRETE).stairs(ModBlocks.GREEN_CONCRETE_STAIRS.get()).slab(ModBlocks.GREEN_CONCRETE_SLAB.get()).wall(ModBlocks.GREEN_CONCRETE_WALL.get()).fence(ModBlocks.GREEN_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily RED_CONCRETE = familyBuilder(Blocks.RED_CONCRETE).stairs(ModBlocks.RED_CONCRETE_STAIRS.get()).slab(ModBlocks.RED_CONCRETE_SLAB.get()).wall(ModBlocks.RED_CONCRETE_WALL.get()).fence(ModBlocks.RED_CONCRETE_FENCE.get()).getFamily();
    public static final BlockFamily BLACK_CONCRETE = familyBuilder(Blocks.BLACK_CONCRETE).stairs(ModBlocks.BLACK_CONCRETE_STAIRS.get()).slab(ModBlocks.BLACK_CONCRETE_SLAB.get()).wall(ModBlocks.BLACK_CONCRETE_WALL.get()).fence(ModBlocks.BLACK_CONCRETE_FENCE.get()).getFamily();
