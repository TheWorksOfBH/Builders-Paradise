...
public class ModBlockFamilies {
    ...
    public static final BlockFamily SULFUR = familyBuilder(Blocks.SULFUR).fence(ModBlocks.SULFUR_FENCE.get()).getFamily();
    public static final BlockFamily POLISHED_SULFUR = familyBuilder(Blocks.POLISHED_SULFUR).fence(ModBlocks.POLISHED_SULFUR_FENCE.get()).getFamily();
    public static final BlockFamily SULFUR_BRICKS = familyBuilder(Blocks.SULFUR_BRICKS).fence(ModBlocks.SULFUR_BRICK_FENCE.get()).getFamily();
    public static final BlockFamily CINNABAR = familyBuilder(Blocks.CINNABAR).fence(ModBlocks.CINNABAR_FENCE.get()).getFamily();
    public static final BlockFamily POLISHED_CINNABAR = familyBuilder(Blocks.POLISHED_CINNABAR).fence(ModBlocks.POLISHED_CINNABAR_FENCE.get()).getFamily();
    public static final BlockFamily CINNABAR_BRICKS = familyBuilder(Blocks.CINNABAR_BRICKS).fence(ModBlocks.CINNABAR_BRICK_FENCE.get()).getFamily();
    ...
    public static final BlockFamily WHITE_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.white()).stairs(ModBlocks.WHITE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.WHITE_TERRACOTTA_SLAB.get()).wall(ModBlocks.WHITE_TERRACOTTA_WALL.get()).fence(ModBlocks.WHITE_TERRACOTTA_FENCE.get()).polished(ModBlocks.WHITE_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily ORANGE_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.orange()).stairs(ModBlocks.ORANGE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.ORANGE_TERRACOTTA_SLAB.get()).wall(ModBlocks.ORANGE_TERRACOTTA_WALL.get()).fence(ModBlocks.ORANGE_TERRACOTTA_FENCE.get()).polished(ModBlocks.ORANGE_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily MAGENTA_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.magenta()).stairs(ModBlocks.MAGENTA_TERRACOTTA_STAIRS.get()).slab(ModBlocks.MAGENTA_TERRACOTTA_SLAB.get()).wall(ModBlocks.MAGENTA_TERRACOTTA_WALL.get()).fence(ModBlocks.MAGENTA_TERRACOTTA_FENCE.get()).polished(ModBlocks.MAGENTA_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily LIGHT_BLUE_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.lightBlue()).stairs(ModBlocks.LIGHT_BLUE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.LIGHT_BLUE_TERRACOTTA_SLAB.get()).wall(ModBlocks.LIGHT_BLUE_TERRACOTTA_WALL.get()).fence(ModBlocks.LIGHT_BLUE_TERRACOTTA_FENCE.get()).polished(ModBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily YELLOW_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.yellow()).stairs(ModBlocks.YELLOW_TERRACOTTA_STAIRS.get()).slab(ModBlocks.YELLOW_TERRACOTTA_SLAB.get()).wall(ModBlocks.YELLOW_TERRACOTTA_WALL.get()).fence(ModBlocks.YELLOW_TERRACOTTA_FENCE.get()).polished(ModBlocks.YELLOW_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily LIME_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.lime()).stairs(ModBlocks.LIME_TERRACOTTA_STAIRS.get()).slab(ModBlocks.LIME_TERRACOTTA_SLAB.get()).wall(ModBlocks.LIME_TERRACOTTA_WALL.get()).fence(ModBlocks.LIME_TERRACOTTA_FENCE.get()).polished(ModBlocks.LIME_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily PINK_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.pink()).stairs(ModBlocks.PINK_TERRACOTTA_STAIRS.get()).slab(ModBlocks.PINK_TERRACOTTA_SLAB.get()).wall(ModBlocks.PINK_TERRACOTTA_WALL.get()).fence(ModBlocks.PINK_TERRACOTTA_FENCE.get()).polished(ModBlocks.PINK_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily GRAY_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.gray()).stairs(ModBlocks.GRAY_TERRACOTTA_STAIRS.get()).slab(ModBlocks.GRAY_TERRACOTTA_SLAB.get()).wall(ModBlocks.GRAY_TERRACOTTA_WALL.get()).fence(ModBlocks.GRAY_TERRACOTTA_FENCE.get()).polished(ModBlocks.GRAY_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily LIGHT_GRAY_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.lightGray()).stairs(ModBlocks.LIGHT_GRAY_TERRACOTTA_STAIRS.get()).slab(ModBlocks.LIGHT_GRAY_TERRACOTTA_SLAB.get()).wall(ModBlocks.LIGHT_GRAY_TERRACOTTA_WALL.get()).fence(ModBlocks.LIGHT_GRAY_TERRACOTTA_FENCE.get()).polished(ModBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily CYAN_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.cyan()).stairs(ModBlocks.CYAN_TERRACOTTA_STAIRS.get()).slab(ModBlocks.CYAN_TERRACOTTA_SLAB.get()).wall(ModBlocks.CYAN_TERRACOTTA_WALL.get()).fence(ModBlocks.CYAN_TERRACOTTA_FENCE.get()).polished(ModBlocks.CYAN_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily PURPLE_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.purple()).stairs(ModBlocks.PURPLE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.PURPLE_TERRACOTTA_SLAB.get()).wall(ModBlocks.PURPLE_TERRACOTTA_WALL.get()).fence(ModBlocks.PURPLE_TERRACOTTA_FENCE.get()).polished(ModBlocks.PURPLE_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily BLUE_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.blue()).stairs(ModBlocks.BLUE_TERRACOTTA_STAIRS.get()).slab(ModBlocks.BLUE_TERRACOTTA_SLAB.get()).wall(ModBlocks.BLUE_TERRACOTTA_WALL.get()).fence(ModBlocks.BLUE_TERRACOTTA_FENCE.get()).polished(ModBlocks.BLUE_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily BROWN_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.brown()).stairs(ModBlocks.BROWN_TERRACOTTA_STAIRS.get()).slab(ModBlocks.BROWN_TERRACOTTA_SLAB.get()).wall(ModBlocks.BROWN_TERRACOTTA_WALL.get()).fence(ModBlocks.BROWN_TERRACOTTA_FENCE.get()).polished(ModBlocks.BROWN_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily GREEN_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.green()).stairs(ModBlocks.GREEN_TERRACOTTA_STAIRS.get()).slab(ModBlocks.GREEN_TERRACOTTA_SLAB.get()).wall(ModBlocks.GREEN_TERRACOTTA_WALL.get()).fence(ModBlocks.GREEN_TERRACOTTA_FENCE.get()).polished(ModBlocks.GREEN_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily RED_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.red()).stairs(ModBlocks.RED_TERRACOTTA_STAIRS.get()).slab(ModBlocks.RED_TERRACOTTA_SLAB.get()).wall(ModBlocks.RED_TERRACOTTA_WALL.get()).fence(ModBlocks.RED_TERRACOTTA_FENCE.get()).polished(ModBlocks.RED_TERRACOTTA_BRICKS.get()).getFamily();
    public static final BlockFamily BLACK_TERRACOTTA = familyBuilder(Blocks.DYED_TERRACOTTA.black()).stairs(ModBlocks.BLACK_TERRACOTTA_STAIRS.get()).slab(ModBlocks.BLACK_TERRACOTTA_SLAB.get()).wall(ModBlocks.BLACK_TERRACOTTA_WALL.get()).fence(ModBlocks.BLACK_TERRACOTTA_FENCE.get()).polished(ModBlocks.BLACK_TERRACOTTA_BRICKS.get()).getFamily();

    public static final BlockFamily WHITE_CONCRETE = familyBuilder(Blocks.CONCRETE.white()).stairs(ModBlocks.WHITE_CONCRETE_STAIRS.get()).slab(ModBlocks.WHITE_CONCRETE_SLAB.get()).wall(ModBlocks.WHITE_CONCRETE_WALL.get()).fence(ModBlocks.WHITE_CONCRETE_FENCE.get()).polished(ModBlocks.WHITE_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily ORANGE_CONCRETE = familyBuilder(Blocks.CONCRETE.orange()).stairs(ModBlocks.ORANGE_CONCRETE_STAIRS.get()).slab(ModBlocks.ORANGE_CONCRETE_SLAB.get()).wall(ModBlocks.ORANGE_CONCRETE_WALL.get()).fence(ModBlocks.ORANGE_CONCRETE_FENCE.get()).polished(ModBlocks.ORANGE_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily MAGENTA_CONCRETE = familyBuilder(Blocks.CONCRETE.magenta()).stairs(ModBlocks.MAGENTA_CONCRETE_STAIRS.get()).slab(ModBlocks.MAGENTA_CONCRETE_SLAB.get()).wall(ModBlocks.MAGENTA_CONCRETE_WALL.get()).fence(ModBlocks.MAGENTA_CONCRETE_FENCE.get()).polished(ModBlocks.MAGENTA_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily LIGHT_BLUE_CONCRETE = familyBuilder(Blocks.CONCRETE.lightBlue()).stairs(ModBlocks.LIGHT_BLUE_CONCRETE_STAIRS.get()).slab(ModBlocks.LIGHT_BLUE_CONCRETE_SLAB.get()).wall(ModBlocks.LIGHT_BLUE_CONCRETE_WALL.get()).fence(ModBlocks.LIGHT_BLUE_CONCRETE_FENCE.get()).polished(ModBlocks.LIGHT_BLUE_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily YELLOW_CONCRETE = familyBuilder(Blocks.CONCRETE.yellow()).stairs(ModBlocks.YELLOW_CONCRETE_STAIRS.get()).slab(ModBlocks.YELLOW_CONCRETE_SLAB.get()).wall(ModBlocks.YELLOW_CONCRETE_WALL.get()).fence(ModBlocks.YELLOW_CONCRETE_FENCE.get()).polished(ModBlocks.YELLOW_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily LIME_CONCRETE = familyBuilder(Blocks.CONCRETE.lime()).stairs(ModBlocks.LIME_CONCRETE_STAIRS.get()).slab(ModBlocks.LIME_CONCRETE_SLAB.get()).wall(ModBlocks.LIME_CONCRETE_WALL.get()).fence(ModBlocks.LIME_CONCRETE_FENCE.get()).polished(ModBlocks.LIME_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily PINK_CONCRETE = familyBuilder(Blocks.CONCRETE.pink()).stairs(ModBlocks.PINK_CONCRETE_STAIRS.get()).slab(ModBlocks.PINK_CONCRETE_SLAB.get()).wall(ModBlocks.PINK_CONCRETE_WALL.get()).fence(ModBlocks.PINK_CONCRETE_FENCE.get()).polished(ModBlocks.PINK_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily GRAY_CONCRETE = familyBuilder(Blocks.CONCRETE.gray()).stairs(ModBlocks.GRAY_CONCRETE_STAIRS.get()).slab(ModBlocks.GRAY_CONCRETE_SLAB.get()).wall(ModBlocks.GRAY_CONCRETE_WALL.get()).fence(ModBlocks.GRAY_CONCRETE_FENCE.get()).polished(ModBlocks.GRAY_CONCRETE_BRICKS.get()).getFamily();
    ...
    public static final BlockFamily CYAN_CONCRETE = familyBuilder(Blocks.CONCRETE.cyan()).stairs(ModBlocks.CYAN_CONCRETE_STAIRS.get()).slab(ModBlocks.CYAN_CONCRETE_SLAB.get()).wall(ModBlocks.CYAN_CONCRETE_WALL.get()).fence(ModBlocks.CYAN_CONCRETE_FENCE.get()).polished(ModBlocks.CYAN_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily PURPLE_CONCRETE = familyBuilder(Blocks.CONCRETE.purple()).stairs(ModBlocks.PURPLE_CONCRETE_STAIRS.get()).slab(ModBlocks.PURPLE_CONCRETE_SLAB.get()).wall(ModBlocks.PURPLE_CONCRETE_WALL.get()).fence(ModBlocks.PURPLE_CONCRETE_FENCE.get()).polished(ModBlocks.PURPLE_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily BLUE_CONCRETE = familyBuilder(Blocks.CONCRETE.blue()).stairs(ModBlocks.BLUE_CONCRETE_STAIRS.get()).slab(ModBlocks.BLUE_CONCRETE_SLAB.get()).wall(ModBlocks.BLUE_CONCRETE_WALL.get()).fence(ModBlocks.BLUE_CONCRETE_FENCE.get()).polished(ModBlocks.BLUE_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily BROWN_CONCRETE = familyBuilder(Blocks.CONCRETE.brown()).stairs(ModBlocks.BROWN_CONCRETE_STAIRS.get()).slab(ModBlocks.BROWN_CONCRETE_SLAB.get()).wall(ModBlocks.BROWN_CONCRETE_WALL.get()).fence(ModBlocks.BROWN_CONCRETE_FENCE.get()).polished(ModBlocks.BROWN_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily GREEN_CONCRETE = familyBuilder(Blocks.CONCRETE.green()).stairs(ModBlocks.GREEN_CONCRETE_STAIRS.get()).slab(ModBlocks.GREEN_CONCRETE_SLAB.get()).wall(ModBlocks.GREEN_CONCRETE_WALL.get()).fence(ModBlocks.GREEN_CONCRETE_FENCE.get()).polished(ModBlocks.GREEN_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily RED_CONCRETE = familyBuilder(Blocks.CONCRETE.red()).stairs(ModBlocks.RED_CONCRETE_STAIRS.get()).slab(ModBlocks.RED_CONCRETE_SLAB.get()).wall(ModBlocks.RED_CONCRETE_WALL.get()).fence(ModBlocks.RED_CONCRETE_FENCE.get()).polished(ModBlocks.RED_CONCRETE_BRICKS.get()).getFamily();
    public static final BlockFamily BLACK_CONCRETE = familyBuilder(Blocks.CONCRETE.black()).stairs(ModBlocks.BLACK_CONCRETE_STAIRS.get()).slab(ModBlocks.BLACK_CONCRETE_SLAB.get()).wall(ModBlocks.BLACK_CONCRETE_WALL.get()).fence(ModBlocks.BLACK_CONCRETE_FENCE.get()).polished(ModBlocks.BLACK_CONCRETE_BRICKS.get()).getFamily();
    ...
    public static final BlockFamily WHITE_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.white()).door(ModBlocks.WHITE_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.WHITE_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily ORANGE_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.orange()).door(ModBlocks.ORANGE_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.ORANGE_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily MAGENTA_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.magenta()).door(ModBlocks.MAGENTA_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.MAGENTA_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily LIGHT_BLUE_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.lightBlue()).door(ModBlocks.LIGHT_BLUE_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.LIGHT_BLUE_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily YELLOW_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.yellow()).door(ModBlocks.YELLOW_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.YELLOW_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily LIME_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.lime()).door(ModBlocks.LIME_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.LIME_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily PINK_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.pink()).door(ModBlocks.PINK_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.PINK_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily GRAY_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.gray()).door(ModBlocks.GRAY_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.GRAY_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily LIGHT_GRAY_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.lightGray()).door(ModBlocks.LIGHT_GRAY_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.LIGHT_GRAY_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily CYAN_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.cyan()).door(ModBlocks.CYAN_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.CYAN_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily PURPLE_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.purple()).door(ModBlocks.PURPLE_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.PURPLE_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily BLUE_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.blue()).door(ModBlocks.BLUE_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.BLUE_STAINED_GLASS_TRAPDOOR.get()).getFamily();
    public static final BlockFamily BROWN_STAINED_GLASS = familyBuilder(Blocks.STAINED_GLASS.brown()).door(ModBlocks.BROWN_STAINED_GLASS_DOOR.get()).trapdoor(ModBlocks.BROWN_STAINED_GLASS_TRAPDOOR.get()).getFamily();
