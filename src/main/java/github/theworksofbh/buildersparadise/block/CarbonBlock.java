...
public class CarbonBlock extends ColoredFallingBlock {

    public CarbonBlock(ColorRGBA dustColor, Properties properties) {
    ...
    protected void randomTick(BlockState state, ServerLevel level, BlockPos pos, RandomSource random) {
        ...
        if (above.is(ModBlockTags.HIGH_PRESSURE_COMPRESSORS)) {
            ...
            if (roll < 0.1) {
                ...
                popResource(level, pos, new ItemStack(ModItems.GRAPHENE.get(), 2));
            }
            else {
                popResource(level, pos, new ItemStack(ModItems.CARBON_DUST.get(), 4));
            }
