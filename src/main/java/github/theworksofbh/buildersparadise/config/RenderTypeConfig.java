...
public class RenderTypeConfig {
    ...
    public static void addModRenderTypes() {
        getKnownBlocks().forEach(block -> {
                        if (block.getDescriptionId().contains("ice") && !block.getDescriptionId().contains("packed") && !block.getDescriptionId().contains("blue") && !block.getDescriptionId().contains("pum") || block.getDescriptionId().contains("nuclear_waste") || block.getDescriptionId().contains("glass")) {
