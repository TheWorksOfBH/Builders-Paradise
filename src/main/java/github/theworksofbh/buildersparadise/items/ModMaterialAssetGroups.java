...
public record ModMaterialAssetGroups(MaterialAssetGroup.AssetInfo base, Map<ResourceKey<EquipmentAsset>, MaterialAssetGroup.AssetInfo> overrides) {
    ...
    public static final MaterialAssetGroup ZINC = create("zinc");
    public static final MaterialAssetGroup SILVER = create("silver");
    public static final MaterialAssetGroup TIN = create("tin");
