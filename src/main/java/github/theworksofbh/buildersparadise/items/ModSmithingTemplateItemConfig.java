...
public class ModSmithingTemplateItemConfig extends SmithingTemplateItem {
    ...
    public ModSmithingTemplateItemConfig(Component appliesTo, Component ingredients, Component baseSlotDescription, Component additionsSlotDescription, List<ResourceLocation> baseSlotEmptyIcons, List<ResourceLocation> additionalSlotEmptyIcons, Properties properties) {
    ...
    private static List<ResourceLocation> createBronzeUpgradeIconList() {
        return List.of(EMPTY_SLOT_HELMET, EMPTY_SLOT_SWORD, EMPTY_SLOT_CHESTPLATE, EMPTY_SLOT_PICKAXE, EMPTY_SLOT_LEGGINGS, EMPTY_SLOT_AXE, EMPTY_SLOT_BOOTS, EMPTY_SLOT_HOE, EMPTY_SLOT_SHOVEL);
    }

    private static List<ResourceLocation> createBronzeUpgradeMaterialList() {
        return List.of(EMPTY_SLOT_INGOT);
    }
    
    static {
        BRONZE_UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(BuildersParadise.MODID, "smithing_template.bronze_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMAT);
        BRONZE_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(BuildersParadise.MODID, "smithing_template.bronze_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMAT);
        BRONZE_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(BuildersParadise.MODID, "smithing_template.bronze_upgrade.base_slot_description")));
        BRONZE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(BuildersParadise.MODID, "smithing_template.bronze_upgrade.additions_slot_description")));
