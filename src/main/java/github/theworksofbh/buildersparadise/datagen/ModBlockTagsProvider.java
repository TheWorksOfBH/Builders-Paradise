...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
                ...
                block -> {
                    if ((block instanceof BasePressurePlateBlock) || block.getDescriptionId().contains("mosaic") || block.getDescriptionId().contains("oak") || block.getDescriptionId().contains("spruce") || block.getDescriptionId().contains("birch") || block.getDescriptionId().contains("jungle") || block.getDescriptionId().contains("acacia") || block.getDescriptionId().contains("crimson") || block.getDescriptionId().contains("warped") || block.getDescriptionId().contains("mangrove") || block.getDescriptionId().contains("cherry") || block.getDescriptionId().contains("bamboo") || (block instanceof CraftingTableBlock) || (block instanceof ChestBlock) || (block instanceof BarrelBlock) || (block instanceof CampfireBlock) || (block instanceof CartographyTableBlock) || (block instanceof BeehiveBlock) || (block instanceof ChiseledBookShelfBlock) || (block instanceof SmithingTableBlock) || (block instanceof LoomBlock) || block.getDescriptionId().contains("bookshelf") || block.getDescriptionId().contains("snow") || block.getDescriptionId().contains("resin") || block.getDescriptionId().contains("sculk")) {
                        ...
                        if (block instanceof TorchBlock || block.getDescriptionId().contains("resin") || block.getDescriptionId().contains("sculk") && !block.getDescriptionId().contains("brick")) {
                            tag(BlockTags.MINEABLE_WITH_PICKAXE).remove(block);
                        } else {
                            tag(BlockTags.MINEABLE_WITH_PICKAXE).add(block);
                        }
                    }
        ...
        getBOPBlocks().forEach(
                block -> {
                    if ((block instanceof BasePressurePlateBlock) || block.getDescriptionId().contains("mosaic") || block.getDescriptionId().contains("oak") || block.getDescriptionId().contains("dead") || block.getDescriptionId().contains("empyreal") || block.getDescriptionId().contains("fir") || block.getDescriptionId().contains("hellbark") || block.getDescriptionId().contains("jacaranda") || block.getDescriptionId().contains("magic") || block.getDescriptionId().contains("mahogany") || block.getDescriptionId().contains("maple") || block.getDescriptionId().contains("palm") || block.getDescriptionId().contains("pine") || block.getDescriptionId().contains("redwood") || block.getDescriptionId().contains("umbran") || block.getDescriptionId().contains("willow") || (block instanceof CraftingTableBlock) || (block instanceof ChestBlock) || (block instanceof BarrelBlock) || (block instanceof CampfireBlock) || (block instanceof CartographyTableBlock) || (block instanceof BeehiveBlock) || (block instanceof ChiseledBookShelfBlock) || (block instanceof SmithingTableBlock) || (block instanceof LoomBlock) || block.getDescriptionId().contains("bookshelf") || block.getDescriptionId().contains("snow") || block.getDescriptionId().contains("resin") || block.getDescriptionId().contains("sculk")) {
                        if (block instanceof BasePressurePlateBlock) {
        ...
        tag(ModBlockTags.GLASS_DOORS)
                ...
                .add(ModBlocks.WHITE_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.ORANGE_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.MAGENTA_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.LIGHT_BLUE_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.YELLOW_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.LIME_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.PINK_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.GRAY_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.LIGHT_GRAY_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.CYAN_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.PURPLE_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.BLUE_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.BROWN_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.GREEN_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.RED_STAINED_GLASS_DOOR.get())
                .add(ModBlocks.BLACK_STAINED_GLASS_DOOR.get());

        tag(ModBlockTags.GLASS_TRAPDOORS)
                .add(ModBlocks.GLASS_TRAPDOOR.get())
                .add(ModBlocks.TINTED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.WHITE_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.ORANGE_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.MAGENTA_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.LIGHT_BLUE_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.YELLOW_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.LIME_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.PINK_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.GRAY_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.LIGHT_GRAY_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.CYAN_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.PURPLE_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.BLUE_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.BROWN_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.GREEN_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.RED_STAINED_GLASS_TRAPDOOR.get())
                .add(ModBlocks.BLACK_STAINED_GLASS_TRAPDOOR.get());
